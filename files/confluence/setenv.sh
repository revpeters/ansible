...
JAVA_HOME='/data/tools/java/current'
export JAVA_HOME
...
CATALINA_OPTS="-XX:G1ReservePercent=20 -XX:+UseTLAB -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=$LOGBASEABS/logs ${CATALINA_OPTS}"
CATALINA_OPTS="-Djava.awt.headless=true -Dfile.encoding=utf8 ${CATALINA_OPTS}"
CATALINA_OPTS="-Datlassian.plugins.enable.wait=300 ${CATALINA_OPTS}"
CATALINA_OPTS="-Xms4096m -Xmx4096m -XX:+UseG1GC -XX:+DisableExplicitGC ${CATALINA_OPTS}"
...
#added per https://getsupport.atlassian.com/servicedesk/customer/portal/30/PS-36653
CATALINA_OPTS="-Dpage.index.macro.max.pages=500 ${CATALINA_OPTS}"
